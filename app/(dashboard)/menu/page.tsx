        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="text-center py-12">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Join or create a household to start adding menu items.
            </p>
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 mt-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <h2 className="text-2xl font-semibold text-gray-400">Hidden Menu Items</h2>
        ...
        {visibleMenuItems.length === 0 && hiddenMenuItems.length === 0 && !showCreateForm && (
          <Card className="text-center py-12">
            ...
            <p className="text-sm text-gray-500">Create your first menu item to get started.</p>
          </Card>
        )}
      </div>
    </div>
